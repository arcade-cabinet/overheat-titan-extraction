 ...
 */
export function HeatSystem(
  world: any,
  delta: number,
  { isGrinding, grindIsRare, upgradeCool }: any
) {
 ...
 */
export function GrindingSystem(
  world: any,
  delta: number,
  { playerPos, upgradePow, isOverheated }: any
) {
...
export function HopperSystem(
  world: any,
  delta: number,
  { grindingCount, upgradePow, upgradeCap }: any
) {
...
export function DebrisCleanupSystem(world: any) {
...
export function VFXCleanupSystem(world: any, delta: number) {
